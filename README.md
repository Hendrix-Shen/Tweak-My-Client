...
|------------|----------|------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| MagicLib   | Required | \>=0.8.721 | [CurseForge](https://www.curseforge.com/minecraft/mc-mods/magiclib) &#124; [Github](https://github.com/Hendrix-Shen/MagicLib)                |
...
The use of this open-source mod is entirely at the user's own discretion. Any risks, losses, or consequences that may arise during the use of resources shall be solely borne by the user. We shall not be held responsible for any direct or indirect losses resulting from the use of this project.
...
If you do not accept any of the above terms and disclaimers, please do not use, install, introduce, or integrate this mod into any of your projects, and please immediately delete any related copies stored on your devices or systems, and cease all usage activities.
