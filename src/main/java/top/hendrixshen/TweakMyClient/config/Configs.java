...
public class Configs implements IConfigHandler {
    ...
    public static class List {
        ...
        public static final ConfigStringList LIST_DISABLE_CLIENT_ENTITY = new TranslatableConfigStringList(PREFIX, "listDisableClientEntityRendering", ImmutableList.of("tnt"));
        public static final ImmutableList<ConfigBase> OPTIONS = ImmutableList.of(
                LIST_AUTO_DROP_BLACK_LIST,
                LIST_AUTO_DROP_TYPE,
                LIST_AUTO_DROP_WHITE_LIST,
                LIST_DISABLE_CLIENT_ENTITY
        );
    }
